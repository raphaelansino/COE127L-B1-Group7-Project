...
unsigned int Hashing::hashComputeByHashFunc(const char * key) //dont know its function yet
{
	unsigned int hash = 1;
	int temp;
	while (temp = *key++)
...
void Hashing::hashTableInsertFunc(const char * key, int value, int index) //IDK
{
